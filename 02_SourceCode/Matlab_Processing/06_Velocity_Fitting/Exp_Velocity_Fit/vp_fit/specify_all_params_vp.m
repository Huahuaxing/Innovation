...
sgtitle('Vp Fitting Result', 'FontSize', 14, 'FontWeight','bold');
for groupi = 1:cycle
    subplot(2,3,groupi);
    title(subTitleList{groupi});
    nonellipse_data = nonellipse_vp(:, groupi);hold on;
