...
%% ---------- 读取文件中波速数据 ----------
v11_ellipse = fullfile('E:\\OneDrive\\Project\\Innovation\\05_ProcessedData\\velocity\\isotropic_matrix\\n_20\\degree_90\\vp_ellipse.csv');
v11_ellipse_data = readmatrix(v11_ellipse);   % 形状 (200,6)

v33_ellipse = fullfile('E:\\OneDrive\\Project\\Innovation\\05_ProcessedData\\velocity\\isotropic_matrix\\n_20\\degree_0\\vp_ellipse.csv');
v33_ellipse_data = readmatrix(v33_ellipse);

v31_ellipse = fullfile('E:\\OneDrive\\Project\\Innovation\\05_ProcessedData\\velocity\\isotropic_matrix\\n_20\\degree_0\\vsv_ellipse.csv');
v31_ellipse_data = readmatrix(v31_ellipse);

v12_ellipse = fullfile('E:\\OneDrive\\Project\\Innovation\\05_ProcessedData\\velocity\\isotropic_matrix\\n_20\\degree_90\\vsh_ellipse.csv');
v12_ellipse_data = readmatrix(v12_ellipse);

vp_de_45_ellipse = fullfile('E:\\OneDrive\\Project\\Innovation\\05_ProcessedData\\velocity\\isotropic_matrix\\n_20\\degree_45\\vp_ellipse.csv');
vp_de_45_ellipse_data = readmatrix(vp_de_45_ellipse);
...
for group = 1:6
    subplot(2, 3, group);
    plot(P, v33_ellipse_data(:, indices(group)), 'r-', 'LineWidth',1.6);
...
c0_11 = v11_ellipse_data .^ 2 * rho;
c0_33 = v33_ellipse_data .^ 2 * rho;
c0_44 = v31_ellipse_data .^ 2 * rho;
c0_66 = v12_ellipse_data .^ 2 * rho;
c0_13 = -c0_44 + sqrt((c0_11+c0_44-2*rho*vp_de_45_ellipse_data.*2) .* (c0_33+c0_44-2*rho*vp_de_45_ellipse_data.*2));
c0_12 = c0_11 - 2 * c0_66;
...
for group = 1:6
    ...
    subplot(2, 3, group);
    plot(P(20:100), v33_ellipse_data(20:100, indices(group)), 'r-', 'LineWidth',1.6);
    hold on;
    plot(P(120:200), v33_ellipse_data(120:200, indices(group)), 'r-', 'LineWidth',1.6);
    hold on;
