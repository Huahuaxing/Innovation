...
% ========== 手动输入每组的A、B、D ==========
A_nonellipse = [2114.35 2116.67 2116.23 2115.7 2117.37 2117.7];
B_nonellipse = [89.1435 95.6123 92.4336 92.3042 93.5743 94.5646];
D_nonellipse = [0.0594515 0.102893 0.0915266 0.0794713 0.0725302 0.120311];
A_ellipse = [2111.33 2107.81 2110.44 2105.98 2108.49 2115.58];
B_ellipse = [77.9198 90.8694 89.4346 82.3073 79.3198 100.337];
D_ellipse = [0.0265816 0.084327 0.0701108 0.0547678 0.0440346 0.104216];
...
for i = 1:cycle
    ...
    try
        [K_fit, resnorm] = lsqcurvefit(fit_func, initialK, P, vp, lbk, ubk, opts);
