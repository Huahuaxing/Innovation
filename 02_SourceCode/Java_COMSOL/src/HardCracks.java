...
public class HardCracks {
     ...
     public static Model run(int n){
          ...
          crack.addCrackData("AR4", 0.00018, 0.018, 16);
          ...
          if(crackType.equals("ellipse")){
               ...
               try (BufferedReader reader = new BufferedReader(new FileReader("E:\\OneDrive\\Project\\Innovation\\Data\\Position\\position" + n + ".txt"))) {
                    String line;
          ...
          String filePath2 = filePath1 + String.format("/0.01AR_%d-cracks-distance-%d-%d-%s", cracksNum, group, n, ARname);
          ...
          for(int i = 1; i <= 40; i++) {
               ...
               model.result().export("tbl" + i)
                         .set("filename", filePath2 + String.format("/%d-cracks-distance-%d~40-%d-%s.txt", cracksNum, i, n, ARname));
          ...
          String newModeldir = "";
          if (crackType.equals("ellipse")) {
               newModeldir = String.format("D:/Projects/Innovation/Data/HardCrack/source/ellipse_aligned_source/第%d组_%s", group, ARname);
          } else {
               newModeldir = String.format("D:/Projects/Innovation/Data/HardCrack/source/polygonal_source/第%d组_%s", group, ARname);
          }
